...
export class LoginComponent implements OnInit {
  ...
  constructor(private title: Title, private fb: FormBuilder, private apiService: ApiService, private router: Router) { }
        ...
        if (token.data) {
          ...
          Swal.fire({
            ...
            if (result.isDismissed) {
              ...
              localStorage.setItem('userlevel_id', (token.data.Department));
              this.isLogin = true;
              // const redirect = this.apiService.redirectUrl ? this.apiService.redirectUrl : '/';
              // this.router.navigate([redirect]);
